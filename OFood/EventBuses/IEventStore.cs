...
namespace OFood.EventBuses
{
    ...
    public interface IEventStore
    {
        ...
        void Add<TEventData, TEventHandler>() where TEventData : class,IEventData where TEventHandler : IEventHandler, new();
        ...
        void Remove<TEventData>(Action<TEventData> action) where TEventData :class, IEventData;
