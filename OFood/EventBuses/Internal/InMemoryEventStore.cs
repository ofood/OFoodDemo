...
namespace OFood.EventBuses.Internal
{
    ...
    internal class InMemoryEventStore : IEventStore
    {
        ...
        public void Add<TEventData, TEventHandler>() where TEventData : class,IEventData where TEventHandler : IEventHandler, new()
        {
        ...
        public void Remove<TEventData>(Action<TEventData> action) where TEventData :class, IEventData
        {
