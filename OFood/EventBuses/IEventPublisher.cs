...
namespace OFood.EventBuses
{
    ...
    public interface IEventPublisher
    {
        ...
        void Publish<TEventData>(TEventData eventData, bool wait = true) where TEventData :class, IEventData;
        ...
        /// <param name="eventData">事件数据</param>
        /// <param name="wait">是否等待结果返回</param>
        void Publish<TEventData>(object eventSource, TEventData eventData, bool wait = true) where TEventData :class, IEventData;
        ...
        /// <param name="eventData">事件数据</param>
        /// <param name="wait">是否等待结果返回</param>
        Task PublishAsync<TEventData>(TEventData eventData, bool wait = true) where TEventData :class, IEventData;
        ...
        /// <param name="eventData">事件数据</param>
        /// <param name="wait">是否等待结果返回</param>
        Task PublishAsync<TEventData>(object eventSource, TEventData eventData, bool wait = true) where TEventData :class, IEventData;
