...
namespace OFood.EventBuses
{
    ...
    public abstract class EventBusBase : IEventBus
    {
        ...
        public virtual void Subscribe<TEventData, TEventHandler>() where TEventData :class, IEventData where TEventHandler : IEventHandler, new()
        {
        ...
        public virtual void Subscribe<TEventData>(Action<TEventData> action) where TEventData :class, IEventData
        {
        ...
        public virtual void Subscribe<TEventData>(IEventHandler eventHandler) where TEventData :class, IEventData
        {
        ...
        {
            eventHandlerTypes.CheckNotNull(nameof(eventHandlerTypes));
        ...
        /// <typeparam name="TEventData">事件数据类型</typeparam>
        /// <param name="action">事件处理委托</param>
        public virtual void Unsubscribe<TEventData>(Action<TEventData> action) where TEventData : class,IEventData
        {
            action.CheckNotNull(nameof(action));
        ...
        /// <typeparam name="TEventData">事件数据类型</typeparam>
        /// <param name="eventHandler">事件处理对象</param>
        public virtual void Unsubscribe<TEventData>(IEventHandler<TEventData> eventHandler) where TEventData :class,IEventData
        {
            eventHandler.CheckNotNull(nameof(eventHandler));
        ...
        /// </summary>
        /// <typeparam name="TEventData">事件数据类型</typeparam>
        public virtual void UnsubscribeAll<TEventData>() where TEventData :class, IEventData
        {
        ...
        public virtual void Publish<TEventData>(TEventData eventData, bool wait = true) where TEventData :class, IEventData
        {
        ...
        /// <param name="eventData">事件数据</param>
        /// <param name="wait">是否等待结果返回</param>
        public virtual void Publish<TEventData>(object eventSource, TEventData eventData, bool wait = true) where TEventData :class, IEventData
        {
        ...
        /// <param name="eventData">事件数据</param>
        /// <param name="wait">是否等待结果返回</param>
        public virtual Task PublishAsync<TEventData>(TEventData eventData, bool wait = true) where TEventData :class, IEventData
        {
        ...
        /// <param name="eventData">事件数据</param>
        /// <param name="wait">是否等待结果返回</param>
        public virtual Task PublishAsync<TEventData>(object eventSource, TEventData eventData, bool wait = true) where TEventData :class, IEventData
        {
